    ...
    return (
      <div className="GVideo">
            <div style={{marginLeft:'-30px'}}>
              <iframe width="900" height="500" src="https://www.youtube.com/embed/LamjAFnybo0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
              <br/><br/>
