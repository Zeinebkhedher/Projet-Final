...
function Emna2(){
    return (
      <div className="GVideo">
            ...
            <iframe width="723" height="409" src="https://www.youtube.com/embed/l2QytoGUsig" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
              <br/><br/>
