...
function Emna1(){
    return (
      <div className="GVideo">
            ...
            <iframe width="723" height="409" src="https://www.youtube.com/embed/Z3pap3mJSxc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
              <br/><br/>
