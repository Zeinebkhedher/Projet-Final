...
function Emna3(){
    return (
      <div className="GVideo">
            ...
            <iframe width="725" height="409" src="https://www.youtube.com/embed/FDvMtYJJUeo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
              <br/><br/>
