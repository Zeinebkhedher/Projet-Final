...
function YZ(){
    return (
      <div className="GVideo">
            ...
            <iframe width="884" height="498" src="https://www.youtube.com/embed/lQtR9Ijx9jU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>            </div>
              <br/><br/>
